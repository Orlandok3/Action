/*
软件名称:bigfun 商店搜索下载
更新时间：2021-01-29 @肥皂 感谢@执意
脚本说明：bigfun连续签到
首次运行脚本，会提示获取Cookie，点击弹窗跳转到bigfun
进入邀好友拿现金，点击签到即可获取Cookie
脚本只有签到功能，请自行提现
TG电报群: https://t.me/hahaha8028
我的邀请码：XKrqE9Y97   万分感谢填写！
...
function bfck() {
   if ($request.url.indexOf("iphone?") > -1) {
    $.setdata(JSON.stringify($request.url),'bfurl')
    $.log(bfurl)
    $.setdata(JSON.stringify($request.headers),'bfhd')
$.log(bfhd)
    $.setdata($request.body,'bfbody')
$.log(bfbody)
